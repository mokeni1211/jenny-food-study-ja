...
Qualtrics.SurveyEngine.addOnload(function () {
  ...
  var STUDY_VERSION = "ccb-ja-qualtrics-1.6.3";
  ...
  style.textContent = [
    ...
    "#food-task-root .ft-intro-image{display:block;width:auto;height:auto;max-width:88vw;max-height:54vh;margin:8px auto 12px;object-fit:contain}",
