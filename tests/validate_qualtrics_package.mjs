...
check(js.includes(".ft-trial-screen{width:min(90vw,1100px);max-width:none;margin-left:calc((100% - min(90vw,1100px))/2)"), "centered expanded trial container not found");
...
check(!js.includes("overflow:hidden") && !js.includes("overflow-x:hidden"), "clipping rule remains on expanded trial display");
