...
check(js.includes("max-width:min(100%,78vw);max-height:58vh"), "viewport-responsive task image sizing not found");
check(js.includes("max-width:min(100%,72vw);max-height:40vh"), "viewport-responsive introduction image sizing not found");
