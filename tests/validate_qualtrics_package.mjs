...
check(js.includes(".ft-trial-screen{width:min(94vw,1200px);max-width:none;margin-left:calc((100% - min(94vw,1200px))/2)"), "centered expanded trial container not found");
